    ...
    return (
        <aside className="main-sidebar sidebar-dark-danger elevation-4">
            <a href="index3.html" className="brand-link bg-danger">
                <img src="dist/img/logo_bac.png" alt="AdminLTE Logo" className="brand-image"
                    />
            ...
            <div className="sidebar">
                <div className="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div className="image">
                        <img src="dist/img/usuario.png" className="img-circle elevation-2" alt="imagen" />
                    </div>
                    <div className="info">
                        <a href="hola" className="d-block">Hola Usuario</a>
                    </div>
                </div>
                <nav className="mt-2">
